...
export async function GET(request){
  ...
  return Response.json({version:'17.21.5',brands:[...BRANDS],categories,products},{headers:{'Cache-Control':'no-store, no-cache, must-revalidate','X-Content-Type-Options':'nosniff'}});
}
